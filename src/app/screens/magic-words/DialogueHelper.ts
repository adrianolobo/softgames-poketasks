...
export class DialogueHelper {
  ...
  public static GetParsedText(text: string, emojies: Map<string, string>) : string
  {
  ...
  public static SetAvatarPosition(avatar: IAvatar, textPadding: number, wordWarpWidthValue: number)
  {
  ...
  public static ShowPhrase(phrase: IPhrase, mainContainer: Container, emojies: Map<string, string>, avatars: Map<string, IAvatar>)
  {
